    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usage_limit', models.PositiveIntegerField(default=0, help_text='จำนวนครั้งที่ใช้ได้ (0 หมายถึงไม่จำกัด)')),
                ('applicable_menus', models.ManyToManyField(blank=True, help_text='ถ้าเว้นว่างหมายถึงโปรโมชั่นใช้ได้กับทุกเมนู', related_name='promotions', to='myapp.menu')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
